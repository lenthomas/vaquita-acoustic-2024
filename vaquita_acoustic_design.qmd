---
title: "Vaquita acoustic survey 2024 - proposed survey design v4"
format: 
  pdf:
    fig-height: 5
editor: source
...
- v3 14th August 2024.  Version suggested for deployment - went to 35 locations per deployment.
- v4 22nd August 2024.  Updated to reduce variation in inclusion probabilities, to get around issue of the same location being sampled multiple times. 
...
#Set those outside the potential_acoustic_sample area to 0
